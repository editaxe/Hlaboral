...
historia_clinica.fecha_time, cliente.cedula, cliente.nombres, cliente.apellido1, cliente.url_img_firma, cliente.url_img_foto, cliente.fecha_nac_time,
cliente.apellido2, administrador.cuenta, administrador.nombres AS nombre_prof, administrador.apellidos AS apellidos_prof, 
tipo_historia_clinica.nombre_tipo_historia_clinica, historia_clinica.nombre_empresa FROM tipo_historia_clinica 
...
<!--<td align="center"><a href="../admin/edit_precio_historia_clinica_mejorada.php?cod_historia_clinica=<?php echo $cod_historia_clinica?>&cod_cliente=<?php echo $cod_cliente?>&pagina=<?php echo $pagina ?>"><img src="../imagenes/precio.png" class="img-polaroid" alt=""></a></td>-->
</tr>
<?php
}
?>
