...
WHERE ((historia_clinica.fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (historia_clinica.nombre_empresa='$nombre_empresa') AND (cod_estado_facturacion=1)) ORDER BY historia_clinica.fecha_ymd DESC";
