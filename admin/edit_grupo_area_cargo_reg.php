...
$actualizar_historia_clinica = "UPDATE grupo_area_cargo SET cod_grupo_area = '$cod_grupo_area', nombre_grupo_area_cargo = '$nombre_grupo_area_cargo' WHERE cod_grupo_area_cargo = '$cod_grupo_area_cargo'";
