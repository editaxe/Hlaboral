...
<?php $sql_consulta = "SELECT fecha_ymd FROM evolucion GROUP BY fecha_ymd ORDER BY fecha_ymd DESC";
...
ON historia_clinica.cod_historia_clinica = evolucion.cod_historia_clinica HAVING (evolucion.fecha_ymd = '$fecha_ymd') ORDER BY evolucion.fecha_time DESC";
