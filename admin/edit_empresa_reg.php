...
$razonsocial_empresa   = addslashes($_POST['razonsocial_empresa']);
...
$cod_tipo_facturacion  = intval($_POST['cod_tipo_facturacion']);

$actualizar_historia_clinica = "UPDATE empresa SET nombre_empresa = '$nombre_empresa', razonsocial_empresa = '$razonsocial_empresa', 
direccion_empresa = '$direccion_empresa', telefono_empresa = '$telefono_empresa', 
nit_empresa = '$nit_empresa', cod_tipo_facturacion = '$cod_tipo_facturacion' WHERE cod_empresa = '$cod_empresa'";
