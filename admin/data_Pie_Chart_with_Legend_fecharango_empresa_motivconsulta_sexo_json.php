...
WHERE ((historia_clinica.fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND ((historia_clinica.cod_estado_facturacion)=1) AND ((cliente.nombre_sexo)='M') AND ((historia_clinica.nombre_empresa)='$nombre_empresa'))
...
FROM cliente RIGHT JOIN historia_clinica ON cliente.cod_cliente = historia_clinica.cod_cliente 
WHERE ((historia_clinica.fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND ((historia_clinica.cod_estado_facturacion)=1) AND ((cliente.nombre_sexo)='F') AND ((historia_clinica.nombre_empresa)='$nombre_empresa'))
GROUP BY cliente.nombre_sexo";
