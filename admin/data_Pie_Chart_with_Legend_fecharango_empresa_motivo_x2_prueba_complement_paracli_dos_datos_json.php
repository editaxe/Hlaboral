...
$query11 = "SELECT fecha_ymd, cod_estado_facturacion, nombre_empresa, Count(paracli_audimet) AS conteo_paracli_audimet, paracli_audimet FROM historia_clinica
...
$query12 = "SELECT fecha_ymd, cod_estado_facturacion, nombre_empresa, Count(paracli_visiomet) AS conteo_paracli_visiomet, paracli_visiomet FROM historia_clinica
...
$query13 = "SELECT fecha_ymd, cod_estado_facturacion, nombre_empresa, Count(paracli_torax) AS conteo_paracli_torax, paracli_torax FROM historia_clinica
...
$query14 = "SELECT fecha_ymd, cod_estado_facturacion, nombre_empresa, Count(paracli_espiro) AS conteo_paracli_espiro, paracli_espiro FROM historia_clinica
...
$query15 = "SELECT fecha_ymd, cod_estado_facturacion, nombre_empresa, Count(paracli_ekg) AS conteo_paracli_ekg, paracli_ekg FROM historia_clinica
...
$query16 = "SELECT fecha_ymd, cod_estado_facturacion, nombre_empresa, Count(paracli_rxcolum) AS conteo_paracli_rxcolum, paracli_rxcolum FROM historia_clinica
...
$query17 = "SELECT fecha_ymd, cod_estado_facturacion, nombre_empresa, Count(paracli_otrcomplement) AS conteo_paracli_otrcomplement, paracli_otrcomplement FROM historia_clinica
...
$query18 = "SELECT fecha_ymd, cod_estado_facturacion, nombre_empresa, Count(paracli_fisiote) AS conteo_paracli_fisiote, paracli_fisiote FROM historia_clinica
...
$query19 = "SELECT fecha_ymd, cod_estado_facturacion, nombre_empresa, Count(paracli_lab) AS conteo_paracli_lab, paracli_lab FROM historia_clinica
...
$query20 = "SELECT fecha_ymd, cod_estado_facturacion, nombre_empresa, Count(paracli_otro) AS conteo_paracli_otro, paracli_otro FROM historia_clinica
