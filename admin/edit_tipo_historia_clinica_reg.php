...
$actualizar_historia_clinica = "UPDATE tipo_historia_clinica SET nombre_tipo_historia_clinica = '$nombre_tipo_historia_clinica' WHERE cod_tipo_historia_clinica = '$cod_tipo_historia_clinica'";
