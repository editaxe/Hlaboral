...
$sql_data = sprintf("UPDATE cliente SET url_img_firma_min = '$url_img_firma_min', url_img_firma = '$url_img_firma_orig' WHERE cod_cliente = '$cod_cliente'");
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));

$sql_data = "UPDATE historia_clinica SET url_img_firma_orig = '$url_img_firma_orig', url_img_firma_min = '$url_img_firma_min' WHERE cod_historia_clinica = '$cod_historia_clinica'";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
