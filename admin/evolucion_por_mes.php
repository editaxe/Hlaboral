...
<?php $sql_consulta = "SELECT fecha_mes FROM evolucion GROUP BY fecha_mes ORDER BY fecha_ymd DESC";
...
ON historia_clinica.cod_historia_clinica = evolucion.cod_historia_clinica HAVING (evolucion.fecha_mes = '$fecha_mes') ORDER BY evolucion.fecha_time DESC";
