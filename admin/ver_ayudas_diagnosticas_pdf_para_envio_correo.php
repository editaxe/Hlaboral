...
cliente.nombres, cliente.apellidos, cliente.fecha_nac_ymd, cliente.fecha_nac_time, cliente.edad_anyo, cliente.nombre_grupo_rh, cliente.tel_cliente, cliente.correo, 
