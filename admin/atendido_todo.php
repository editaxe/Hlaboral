...
WHERE ((historia_clinica.cod_estado_facturacion)=1) ORDER BY historia_clinica.fecha_time DESC";
$resultado_cliente = mysqli_query($conectar, $sql_cliente);
/* --------------------------------------------------------------------------------------------------------------------------------- */
/* --------------------------------------------------------------------------------------------------------------------------------- */
$sql_conteo_citas = "SELECT COUNT(cod_historia_clinica) AS conteo_historia_clinica FROM historia_clinica";
...
/* --------------------------------------------------------------------------------------------------------------------------------- */
$sql_conteo_atendido = "SELECT COUNT(cod_historia_clinica) AS conteo_historia_clinica FROM historia_clinica WHERE cod_estado_facturacion = '1'";
...
/* --------------------------------------------------------------------------------------------------------------------------------- */
/* --------------------------------------------------------------------------------------------------------------------------------- */
$sql_conteo_no_atendido = "SELECT COUNT(cod_historia_clinica) AS conteo_historia_clinica FROM historia_clinica WHERE cod_estado_facturacion = '0'";
...
/* --------------------------------------------------------------------------------------------------------------------------------- */
/* --------------------------------------------------------------------------------------------------------------------------------- */
$sql_conteo_evolucion = "SELECT COUNT(cod_evolucion) AS conteo_evoluciones FROM evolucion";
...
/* --------------------------------------------------------------------------------------------------------------------------------- */
/* --------------------------------------------------------------------------------------------------------------------------------- */
$sql_conteo_atendido_hombre = "SELECT Count(cliente.nombre_sexo) AS conteo_hombre, cliente.nombre_sexo, historia_clinica.cod_estado_facturacion
FROM cliente LEFT JOIN historia_clinica ON cliente.cod_cliente = historia_clinica.cod_cliente
GROUP BY cliente.nombre_sexo, historia_clinica.cod_estado_facturacion
HAVING (((cliente.nombre_sexo)='M') AND ((historia_clinica.cod_estado_facturacion)=1))";
...
/* --------------------------------------------------------------------------------------------------------------------------------- */
/* --------------------------------------------------------------------------------------------------------------------------------- */
$sql_conteo_atendido_mujer = "SELECT Count(cliente.nombre_sexo) AS conteo_mujer, cliente.nombre_sexo, historia_clinica.cod_estado_facturacion
FROM cliente LEFT JOIN historia_clinica ON cliente.cod_cliente = historia_clinica.cod_cliente
GROUP BY cliente.nombre_sexo, historia_clinica.cod_estado_facturacion
HAVING (((cliente.nombre_sexo)='F') AND ((historia_clinica.cod_estado_facturacion)=1))";
