...
<center>
<?php
$query1 = "SELECT historia_clinica.$tipo_fecha, historia_clinica.cod_estado_facturacion, 
Count(historia_clinica.dat_ocupa_carg1) AS conteo_dat_ocupa_carg1, historia_clinica.dat_ocupa_carg1, historia_clinica.nombre_empresa
FROM historia_clinica
GROUP BY historia_clinica.$tipo_fecha, historia_clinica.cod_estado_facturacion, historia_clinica.dat_ocupa_carg1, historia_clinica.nombre_empresa
HAVING (((historia_clinica.$tipo_fecha)='$fecha') AND ((historia_clinica.cod_estado_facturacion)=1) AND ((historia_clinica.nombre_empresa)='$nombre_empresa'))";
$result1 = mysqli_query($conectar, $query1);

$query2 = "SELECT historia_clinica.$tipo_fecha, historia_clinica.cod_estado_facturacion, 
Count(historia_clinica.dat_ocupa_carg1) AS conteo_dat_ocupa_carg1, historia_clinica.dat_ocupa_carg1, historia_clinica.nombre_empresa
FROM historia_clinica
GROUP BY historia_clinica.$tipo_fecha, historia_clinica.cod_estado_facturacion, historia_clinica.nombre_empresa
HAVING (((historia_clinica.$tipo_fecha)='$fecha') AND ((historia_clinica.cod_estado_facturacion)=1) AND ((historia_clinica.nombre_empresa)='$nombre_empresa'))";
$result2 = mysqli_query($conectar, $query2);
$datos2 = mysqli_fetch_assoc($result2);
?>
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
<?php
$query1 = "SELECT historia_clinica.$tipo_fecha, cliente.fecha_nac_time, 
...
HAVING (((historia_clinica.$tipo_fecha)='$fecha') AND (cod_estado_facturacion=1) AND ((nombre_empresa)='$nombre_empresa')) ORDER BY conteo_nombre_escolaridad DESC LIMIT 0,3";
$result1 = mysqli_query($conectar, $query1);
...
<br><br>
<tr><td style="text-align:center">El Nivel de escolaridad, con mayor porcentaje dentro de la Empresa corresponde a 
...
FROM historia_clinica
GROUP BY historia_clinica.$tipo_fecha, cod_estado_facturacion, nombre_escolaridad, nombre_empresa
HAVING (((historia_clinica.$tipo_fecha)='$fecha') AND (cod_estado_facturacion=1) AND ((nombre_empresa)='$nombre_empresa')) ORDER BY conteo_nombre_escolaridad DESC";
$result2 = mysqli_query($conectar, $query2);
...
FROM historia_clinica HAVING ((($tipo_fecha)='$fecha') AND (cod_estado_facturacion=1) AND ((nombre_empresa)='$nombre_empresa'))";
$result1 = mysqli_query($conectar, $query1);
...
HAVING (((historia_clinica.fecha_mes)='$fecha') AND ((historia_clinica.cod_estado_facturacion)=1) AND ((historia_clinica.nombre_empresa)='$nombre_empresa')) ORDER BY conteo_cie10_cod DESC";
$result1 = mysqli_query($conectar, $query1);
?>

<tr><td style="text-align:left"><strong>3.6. PRINCIPALES DIAGNÓSTICOS</strong></td></tr>
<br><br>
<tr><td style="text-align:center">Las patologías de mayor incidencia encontradas en los Trabajadores evaluados en el <?php echo $nombre_empresa ?>, se presentan a continuación:<br></td></tr>
