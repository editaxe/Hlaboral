...
$actualizar_historia_clinica = "UPDATE empresa_contratante SET nombre_empresa_contratante = '$nombre_empresa_contratante' WHERE cod_empresa_contratante = '$cod_empresa_contratante'";
