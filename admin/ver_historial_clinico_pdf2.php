...
$sql_historia_clinica = "SELECT historia_clinica.cod_historia_clinica, historia_clinica.estructura_tipo_historia_clinica, cliente.cod_cliente, 
cliente.nombre_ocupacion, cliente.cod_entidad, cliente.cedula, cliente.nombres, cliente.apellido1, cliente.apellido2, cliente.fecha_nac_ymd, 
cliente.fecha_nac_time, cliente.edad_anyo, cliente.nombre_grupo_rh, cliente.tel_cliente, cliente.correo, 
cliente.direccion, cliente.nombre_ciudad, cliente.nombre_pais, historia_clinica.motivo, historia_clinica.nombre_laboratorio, historia_clinica.fecha_reg_time, 
