...
cliente.apellido2, historia_clinica.motivo, historia_clinica.fecha_time, historia_clinica.fecha_ymd, historia_clinica.cuenta, historia_clinica.hora
FROM cliente RIGHT JOIN historia_clinica ON cliente.cod_cliente = historia_clinica.cod_cliente WHERE historia_clinica.cod_estado_facturacion = '1' ORDER BY historia_clinica.fecha_reg_time DESC";
...
<td id="fecha_ymd<?php echo $cod_historia_clinica;?>"><?php echo $fecha_ymd?></td>
