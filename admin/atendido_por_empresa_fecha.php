...
<div class="breadcrumbs"><a href="#"><h4>Lista de Paciente Atendidos Por Empresa Y Fecha</h4></a></div>
<div class="row-fluid">
...
<?php if (isset($fecha_ymd)) { echo "<option value='-1' >...</option>";
} else { echo  "<option value='-1' selected >...</option>"; }
...
historia_clinica.cod_administrador, historia_clinica.cod_cliente, historia_clinica.cod_factura, historia_clinica.costo_motivo_consulta,
...
WHERE ((historia_clinica.nombre_empresa)='$nombre_empresa') AND (historia_clinica.fecha_ymd = '$fecha_ymd') AND ((historia_clinica.cod_estado_facturacion)=1) ORDER BY historia_clinica.fecha_time DESC";
...
FROM empresa RIGHT JOIN (cliente RIGHT JOIN (administrador RIGHT JOIN historia_clinica ON administrador.cod_administrador = historia_clinica.cod_administrador) 
ON cliente.cod_cliente = historia_clinica.cod_cliente) ON empresa.nombre_empresa = historia_clinica.nombre_empresa
WHERE ((historia_clinica.nombre_empresa)='$nombre_empresa') AND (historia_clinica.fecha_ymd = '$fecha_ymd')";
...
FROM empresa RIGHT JOIN (cliente RIGHT JOIN (administrador RIGHT JOIN historia_clinica ON administrador.cod_administrador = historia_clinica.cod_administrador) 
ON cliente.cod_cliente = historia_clinica.cod_cliente) ON empresa.nombre_empresa = historia_clinica.nombre_empresa
WHERE ((historia_clinica.nombre_empresa)='$nombre_empresa') AND (historia_clinica.fecha_ymd = '$fecha_ymd') AND ((historia_clinica.cod_estado_facturacion)=1)";
...
FROM empresa RIGHT JOIN (cliente RIGHT JOIN (administrador RIGHT JOIN historia_clinica ON administrador.cod_administrador = historia_clinica.cod_administrador) 
ON cliente.cod_cliente = historia_clinica.cod_cliente) ON empresa.nombre_empresa = historia_clinica.nombre_empresa
WHERE ((historia_clinica.nombre_empresa)='$nombre_empresa') AND (historia_clinica.fecha_ymd = '$fecha_ymd') AND ((historia_clinica.cod_estado_facturacion)=0)";
...
GROUP BY historia_clinica.fecha_ymd, historia_clinica.nombre_empresa, historia_clinica.cod_estado_facturacion, cliente.nombre_sexo
HAVING (((historia_clinica.nombre_empresa)='$nombre_empresa') AND (historia_clinica.fecha_ymd = '$fecha_ymd') AND ((historia_clinica.cod_estado_facturacion)=1) AND ((cliente.nombre_sexo)='M'))";
...
FROM empresa RIGHT JOIN (cliente RIGHT JOIN (administrador RIGHT JOIN historia_clinica ON administrador.cod_administrador = historia_clinica.cod_administrador) ON cliente.cod_cliente = historia_clinica.cod_cliente) ON empresa.nombre_empresa = historia_clinica.nombre_empresa
GROUP BY historia_clinica.fecha_ymd, historia_clinica.nombre_empresa, historia_clinica.cod_estado_facturacion, cliente.nombre_sexo
HAVING (((historia_clinica.nombre_empresa)='$nombre_empresa') AND (historia_clinica.fecha_ymd = '$fecha_ymd') AND ((historia_clinica.cod_estado_facturacion)=1) AND ((cliente.nombre_sexo)='F'))";
