...
$sql_remision = "SELECT remision.cod_remision, cliente.cod_cliente, cliente.nombre_tipo_doc, 
remision.cod_grupo_area, remision.cod_grupo_area_cargo, remision.costo_motivo_consulta, remision.cod_factura, remision.nombre_ocupacion, 
remision.nombre_empresa, remision.cargo_empresa, remision.area_empresa, remision.ciudad_empresa, remision.nombre_empresa_contratante,
cliente.cod_entidad, cliente.cedula, cliente.nombre_sexo, remision.estructura_remision, remision.nombre_tipo_remision, 
...
cliente.url_img_foto AS url_img_foto_cli, cliente.nombres, cliente.apellido1, cliente.apellido2, cliente.fecha_nac_ymd, cliente.fecha_nac_time, 
...
cliente.lugar_residencia, remision.motivo, remision.fecha_reg_time, 
remision.fecha_time, remision.fecha_ymd, remision.cuenta, 
remision.exa_fis_talla, remision.exa_fis_peso, remision.exa_fis_imc, 
remision.exa_fis_interpreimc, remision.exa_fis_fresp, remision.exa_fis_ta, 
remision.exa_fis_fc, remision.exa_fis_lateral, remision.exa_fis_periabdom, 
remision.exa_fis_temperat, remision.exa_fis_ojoder_sncorre_vlejan, 
remision.exa_fis_ojoder_sncorre_vcerca, remision.exa_fis_ojoder_cncorre_vlejan, 
remision.exa_fis_ojoder_cncorre_vcerca, remision.exa_fis_ojoizq_sncorre_vlejan, 
remision.exa_fis_ojoizq_sncorre_vcerca, remision.exa_fis_ojoizq_cncorre_vlejan, 
remision.exa_fis_ojoizq_cncorre_vcerca, remision.exa_fis_ojoamb_sncorre_vlejan, 
remision.exa_fis_ojoamb_sncorre_vcerca, remision.exa_fis_oojoamb_cncorre_vlejan, 
remision.exa_fis_ojoamb_cncorre_vcerca, remision.fecha_dmy 
FROM cliente RIGHT JOIN remision ON cliente.cod_cliente = remision.cod_cliente 
WHERE (remision.cod_remision = '$cod_remision')";
...
<table align="center" border="1" cellspacing="0" cellpadding="0" style="font-family:mono;  font-size:'.$tamano_font_remision_emp.'pt; width:100%">
 <tbody>
  <tr>
    ...
    <td align="center"><barcode code="'.$cod_remision_strpad.'" type="C128A" size="0.5" height="1" /></td>
  </tr>
  <tr><td align="center">FECHA: '.$fecha_hisroria_clinica.'</td></tr><tr><td align="center">CRM: '.$cod_remision.'</td></tr>
 </tbody>
</table>
';
$headerE = '
