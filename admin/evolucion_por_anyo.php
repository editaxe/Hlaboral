...
<?php $sql_consulta = "SELECT fecha_anyo FROM evolucion GROUP BY fecha_anyo ORDER BY fecha_ymd DESC";
...
ON historia_clinica.cod_historia_clinica = evolucion.cod_historia_clinica HAVING (evolucion.fecha_anyo = '$fecha_anyo') ORDER BY evolucion.fecha_time DESC";
