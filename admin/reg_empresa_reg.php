...
$obtener_empresa = "SELECT nombre_empresa FROM empresa WHERE nombre_empresa = '".($nombre_empresa)."'";
...
<?php } else {
$sql_data = "INSERT INTO empresa (nombre_empresa, direccion_empresa, telefono_empresa, nit_empresa) 
