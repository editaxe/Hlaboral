...
$sql_data = "UPDATE historia_clinica SET url_img_foto_orig = '$url_img_foto_orig', url_img_foto_min = '$url_img_foto_min' WHERE cod_historia_clinica = '$cod_historia_clinica'";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
