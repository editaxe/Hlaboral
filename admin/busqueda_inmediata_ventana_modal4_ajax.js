...
xmlhttp.onreadystatechange=function() {
  if (xmlhttp.readyState==4 && xmlhttp.status==200) {
    ...
    }else{ document.getElementById("logo_cargador").innerHTML='<img src="../imagenes/cargador.gif" width="25" height="25" />'; }
  }
xmlhttp.open("POST","busqueda_inmediata_ventana_modal4_php.php",true);
