...
$query1 = "SELECT historia_clinica.$tipo_fecha, cliente.fecha_nac_ymd, cliente.fecha_nac_time, historia_clinica.nombre_empresa, historia_clinica.cod_estado_facturacion
FROM cliente RIGHT JOIN historia_clinica ON cliente.cod_cliente = historia_clinica.cod_cliente
WHERE (((historia_clinica.$tipo_fecha)='$fecha') AND ((historia_clinica.cod_estado_facturacion)=1) AND ((historia_clinica.nombre_empresa)='$nombre_empresa'))";
