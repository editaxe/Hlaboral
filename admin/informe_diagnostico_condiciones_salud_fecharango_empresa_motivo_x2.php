...
WHERE ((historia_clinica.fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (historia_clinica.nombre_empresa='$nombre_empresa') AND (historia_clinica.motivo='$motivo') AND (historia_clinica.cod_estado_facturacion=1) AND ((cliente.nombre_sexo)='M'))
...
FROM cliente RIGHT JOIN historia_clinica ON cliente.cod_cliente = historia_clinica.cod_cliente 
WHERE ((historia_clinica.fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (historia_clinica.nombre_empresa='$nombre_empresa') AND (historia_clinica.motivo='$motivo') AND (historia_clinica.cod_estado_facturacion=1) AND ((cliente.nombre_sexo)='F'))
GROUP BY cliente.nombre_sexo";
$result2 = mysqli_query($conectar, $query2);
$datos2 = mysqli_fetch_assoc($result2);
...
<tr><td style="text-align:left"><br><br>Se encontró predominio del sexo <?php echo $sexo_txt ?> con el <?php echo round($porcentaje_sexo, 2) ?>%.</td></tr>
</table>
</div>
...
FROM cliente RIGHT JOIN historia_clinica ON cliente.cod_cliente = historia_clinica.cod_cliente
HAVING ((fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (historia_clinica.nombre_empresa='$nombre_empresa') AND (historia_clinica.motivo='$motivo') AND (historia_clinica.cod_estado_facturacion=1))";
$result1 = mysqli_query($conectar, $query1);
...
WHERE ((historia_clinica.fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (historia_clinica.nombre_empresa='$nombre_empresa') AND (historia_clinica.motivo='$motivo') AND (historia_clinica.cod_estado_facturacion=1)) 
GROUP BY historia_clinica.nombre_empresa, cie10diag.cie10_diag, historia_clinica.motivo ORDER BY conteo_cie10_cod DESC";
$result1 = mysqli_query($conectar, $query1);
?>
