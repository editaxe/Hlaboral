...
//---------------------------------------------------------------------------------------------------------------------------------------------//
$actualizar_info_paciente= "UPDATE cliente SET nombre_tipo_doc = '$nombre_tipo_doc', cedula = '$cedula', nombres = '$nombres', 
...
//---------------------------------------------------------------------------------------------------------------------------------------------//
$actualizar_info_aptlab= "UPDATE actitud_laboral SET motivo_actilab = '$motivo' WHERE cod_historia_clinica = '$cod_historia_clinica'";
