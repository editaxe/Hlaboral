...
//-----------------------------------------------------------------------------------------------------//
//-----------------------------------------------------------------------------------------------------//
$sql_info_factura = "SELECT * FROM info_factura WHERE cod_factura = '$cod_factura_max'";
...
$sql_data = "INSERT INTO info_factura (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo , motivo, fecha_ymdhis, cuenta) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa', '$total_motivo', '$motivo', '$fecha_ymdhis', '$cuenta')";
...
cod_estado_facturacion, nombre_empresa, motivo FROM historia_clinica 
...
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO info_factura (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo , motivo, motivo2, fecha_ymdhis, cuenta) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa', '$total_motivo', '$motivo', '$motivo2', '$fecha_ymdhis', '$cuenta')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
...
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO info_factura (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo , motivo, motivo2, motivo3, fecha_ymdhis, cuenta) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa', '$total_motivo', '$motivo', '$motivo2', '$motivo3', '$fecha_ymdhis', '$cuenta')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
...
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO info_factura (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo , motivo, motivo2, motivo3, motivo4, fecha_ymdhis, cuenta) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa', '$total_motivo', '$motivo', '$motivo2', '$motivo3', '$motivo4', '$fecha_ymdhis', '$cuenta')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
...
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO info_factura (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo , motivo, motivo2, motivo3, motivo4, motivo5, fecha_ymdhis, cuenta) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa', '$total_motivo', '$motivo', '$motivo2', '$motivo3', '$motivo4', '$motivo5', '$fecha_ymdhis', '$cuenta')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
...
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO info_factura (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo , motivo, motivo2, motivo3, motivo4, motivo5, motivo6, fecha_ymdhis, cuenta) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa', '$total_motivo', '$motivo', '$motivo2', '$motivo3', '$motivo4', '$motivo5', '$motivo6', '$fecha_ymdhis', '$cuenta')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
...
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO info_factura (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo , motivo, motivo2, motivo3, motivo4, motivo5, motivo6, motivo7, fecha_ymdhis, cuenta) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa', '$total_motivo', '$motivo', '$motivo2', '$motivo3', '$motivo4', '$motivo5', '$motivo6', '$motivo7', '$fecha_ymdhis', '$cuenta')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
...
$cod_factura                    = $info_info_factura['cod_factura']+1;
$sql_data = "INSERT INTO info_factura (cod_factura, fecha_ini, fecha_fin, nombre_empresa, total_motivo , motivo, motivo2, motivo3, motivo4, motivo5, motivo6, motivo7, motivo8, fecha_ymdhis, cuenta) 
VALUES ('$cod_factura', '$fecha_ini', '$fecha_fin', '$nombre_empresa', '$total_motivo', '$motivo', '$motivo2', '$motivo3', '$motivo4', '$motivo5', '$motivo6', '$motivo7', '$motivo8', '$fecha_ymdhis', '$cuenta')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
}
//-----------------------------------------------------------------------------------------------------//
$sql_motivo_conteo = "SELECT Count(motivo) AS conteo_motivo, Sum(costo_motivo_consulta) AS sum_costo_motivo_consulta, costo_motivo_consulta, fecha_ymd, 
