...
<td style="text-align:center"><input style="text-align:center" class="input-block-level" name="costo_motivo_consulta" id="<?php echo $cod_historia_clinica ?>" type="number" value="<?php echo $costo_motivo_consulta ?>" required/></td>
</tr>
...
<td style="text-align:center"><select name="nombre_empresa_contratante" id="<?php echo $cod_historia_clinica ?>">
...
<td style="text-align:center"><select name="nombre_empresa" id="nombre_empresa" onChange="conocer_empresa_laborar();">
...
<td style="text-align:center">
<input style="text-align:center" name="cod_grupo_area_cargo" id="cod_grupo_area_cargo" class="cod_grupo_area_cargo" onChange="conocer_cargo();" type="text" value="<?php echo $cod_grupo_area_cargo ?>" required/>
<spam>&nbsp;&nbsp;&nbsp;<input name="activar_area_y_cargo" id="activar_area_y_cargo" type="checkbox" value="SI" /><strong>Nuevo Cargo</strong></spam>
<div id="nombre_grupo_area_nuevo" style="display:none;">&nbsp;&nbsp;&nbsp;<strong>Area a Laborar:</strong> <input name="nombre_grupo_area" id="nombre_grupo_area" type="text" value="" /></div>
<div id="nombre_grupo_area_cargo_nuevo" style="display:none;">&nbsp;&nbsp;&nbsp;<strong>Cargo a Laborar:</strong> <input name="nombre_grupo_area_cargo" id="nombre_grupo_area_cargo" type="text" value="" /></div>
<div id="guardar_area_y_cargo" style="display:none;"><a href="">Guardar Area y Cargo</a></div>
</td>
...
<!-- /////////////////////////////////////////////////// -->
<table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:<?php echo $tamano_font_emp ?>pt; width:100%">
    <tbody><tr><td bgcolor="#FAC090"><strong>3.6 Antecedentes - Inmunizaciones (Presenta Vacunas:&nbsp;&nbsp;&nbsp; SI<input type="radio" name="ant_inmuni" id="<?php echo $cod_historia_clinica ?>" value="SI" required>&nbsp;&nbsp;&nbsp;NO<input type="radio" name="ant_inmuni" id="<?php echo $cod_historia_clinica ?>" value="NO">)</strong></td></tr></tbody>
</table>
<table align="center" border="1" style="font-family:mono; font-size:<?php echo $tamano_font_emp ?>pt; width:100%">
    <tbody>
        <tr>
...
Normal<input type="radio" name="exaosteo_homb_movart" id="<?php echo $cod_historia_clinica ?>" value="Normal" <?php echo ($exaosteo_homb_movart=='Normal')?'checked':'' ?> required>&nbsp;&nbsp;&nbsp;
...
Normal<input type="radio" name="exaosteo_homb_fuerza" id="<?php echo $cod_historia_clinica ?>" value="Normal" <?php echo ($exaosteo_homb_fuerza=='Normal')?'checked':'' ?> required>&nbsp;&nbsp;&nbsp;
...
<td style="text-align:center"><strong>
Pos<input type="radio" name="exaosteo_manjobe_sig" id="<?php echo $cod_historia_clinica ?>" value="Pos" <?php echo ($exaosteo_manjobe_sig=='Pos')?'checked':'' ?> required>&nbsp;&nbsp;&nbsp;
...
<td style="text-align:center"><strong>
Der<input type="radio" name="exaosteo_manjobe_lat" id="<?php echo $cod_historia_clinica ?>" value="Der" <?php echo ($exaosteo_manjobe_lat=='Der')?'checked':'' ?> required>&nbsp;&nbsp;&nbsp;
...
<td style="text-align:center" colspan="2"><strong>
Normal<input type="radio" name="exaosteo_manjobe_movart" id="<?php echo $cod_historia_clinica ?>" value="Normal" <?php echo ($exaosteo_manjobe_movart=='Normal')?'checked':'' ?> required>&nbsp;&nbsp;&nbsp;
...
<td style="text-align:center" colspan="3"><strong>
Normal<input type="radio" name="exaosteo_manjobe_fuerza" id="<?php echo $cod_historia_clinica ?>" value="Normal" <?php echo ($exaosteo_manjobe_fuerza=='Normal')?'checked':'' ?> required>&nbsp;&nbsp;&nbsp;
...
<td><strong>Columna</strong></td>
<td style="text-align:center" colspan="2"><strong>
Normal<input type="radio" name="exaosteo_manyega_movart" id="<?php echo $cod_historia_clinica ?>" value="Normal" <?php echo ($exaosteo_manyega_movart=='Normal')?'checked':'' ?> required>&nbsp;&nbsp;&nbsp;
...
<td style="text-align:center" colspan="3"><strong>
Normal<input type="radio" name="exaosteo_manyega_fuerza" id="<?php echo $cod_historia_clinica ?>" value="Normal" <?php echo ($exaosteo_manyega_fuerza=='Normal')?'checked':'' ?> required>&nbsp;&nbsp;&nbsp;
...
<td style="text-align:center"><strong>
Pos<input type="radio" name="exaosteo_epicond_sig" id="<?php echo $cod_historia_clinica ?>" class="exaosteo_epicond_sig" value="Pos" <?php echo ($exaosteo_epicond_sig=='Pos')?'checked':'' ?> required>&nbsp;&nbsp;&nbsp;
Neg<input type="radio" name="exaosteo_epicond_sig" id="<?php echo $cod_historia_clinica ?>" class="exaosteo_epicond_sig" value="Neg" <?php echo ($exaosteo_epicond_sig=='Neg')?'checked':'' ?> ></strong></td>

<td style="text-align:center"><strong>
Der<input type="radio" name="exaosteo_epicond_lat" id="<?php echo $cod_historia_clinica ?>" class="exaosteo_epicond_lat" value="Der" <?php echo ($exaosteo_epicond_lat=='Der')?'checked':'' ?> required>&nbsp;&nbsp;&nbsp;
Izq<input type="radio" name="exaosteo_epicond_lat" id="<?php echo $cod_historia_clinica ?>" class="exaosteo_epicond_lat" value="Izq" <?php echo ($exaosteo_epicond_lat=='Izq')?'checked':'' ?> >&nbsp;&nbsp;&nbsp;&nbsp;
AM<input type="radio" name="exaosteo_epicond_lat" id="<?php echo $cod_historia_clinica ?>" class="exaosteo_epicond_lat" value="AM" <?php echo ($exaosteo_epicond_lat=='AM')?'checked':'' ?> ></strong></td>

<td colspan="2"><strong>Phalen</strong></td>
<td style="text-align:center" colspan="2"><strong>
Pos<input type="radio" name="exaosteo_phalen_sig" id="<?php echo $cod_historia_clinica ?>" value="Pos" <?php echo ($exaosteo_phalen_sig=='Pos')?'checked':'' ?> required>&nbsp;&nbsp;&nbsp;
...
<td style="text-align:center" colspan="2"><strong>
Der<input type="radio" name="exaosteo_phalen_lat" id="<?php echo $cod_historia_clinica ?>" value="Der" <?php echo ($exaosteo_phalen_lat=='Der')?'checked':'' ?> required>&nbsp;&nbsp;&nbsp;
...
<td style="text-align:center" colspan="2"><strong>
Pos<input type="radio" name="exaosteo_cajon_sig" id="<?php echo $cod_historia_clinica ?>" value="Pos" <?php echo ($exaosteo_cajon_sig=='Pos')?'checked':'' ?> required>&nbsp;&nbsp;&nbsp;
...
<td style="text-align:center" colspan="2"><strong>
Der<input type="radio" name="exaosteo_cajon_lat" id="<?php echo $cod_historia_clinica ?>" value="Der" <?php echo ($exaosteo_cajon_lat=='Der')?'checked':'' ?> required>&nbsp;&nbsp;&nbsp;
...
$.ajax({  
    ...
    method:"POST",  
    data:{valor:valor, campo:campo, id:<?php echo $cod_historia_clinica ?>, cod_cliente:<?php echo $cod_cliente ?>},  
...
$.ajax({  
    url:"guardar_edit_historia_clinica_mejorada_ajax.php",  
    method:"POST",  
    data:{valor:valor, campo:"exa_fis_talla", id:<?php echo $cod_historia_clinica ?>, cod_cliente:<?php echo $cod_cliente ?>},  
    success:function(data){  
         $('#result').html(data);  
    }  
});  
...
$.ajax({  
    url:"guardar_edit_historia_clinica_mejorada_ajax.php",  
    method:"POST",  
    data:{valor:valor, campo:"exa_fis_peso", id:<?php echo $cod_historia_clinica ?>, cod_cliente:<?php echo $cod_cliente ?>},  
    success:function(data){  
         $('#result').html(data);  
    }  
});  
...
$.ajax({  
    url:"guardar_edit_historia_clinica_mejorada_ajax.php",  
    method:"POST",  
    data:{valor:valor, campo:"exa_fis_imc", id:<?php echo $cod_historia_clinica ?>, cod_cliente:<?php echo $cod_cliente ?>},  
    success:function(data){  
         $('#result').html(data);  
    }  
});  
...
$.ajax({  
    url:"guardar_edit_historia_clinica_mejorada_ajax.php",  
    method:"POST",  
    data:{valor:valor, campo:"exa_fis_interpreimc", id:<?php echo $cod_historia_clinica ?>, cod_cliente:<?php echo $cod_cliente ?>},  
    success:function(data){  
         $('#result').html(data);  
    }  
});  
