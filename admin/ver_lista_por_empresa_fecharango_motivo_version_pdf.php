...
historia_clinica.fecha_ymd, historia_clinica.nombre_empresa 
...
AND ((historia_clinica.motivo='$motivo')) AND (cod_estado_facturacion=1)) ORDER BY historia_clinica.fecha_ymd DESC";
...
FROM cliente RIGHT JOIN historia_clinica ON cliente.cod_cliente = historia_clinica.cod_cliente 
WHERE ((historia_clinica.fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (historia_clinica.nombre_empresa='$nombre_empresa') 
AND ((historia_clinica.motivo='$motivo') OR (historia_clinica.motivo='$motivo2')) AND (cod_estado_facturacion=1)) ORDER BY historia_clinica.fecha_ymd DESC";
$resultado_motivo_conteo = mysqli_query($conectar, $sql_motivo_conteo);
}
...
FROM cliente RIGHT JOIN historia_clinica ON cliente.cod_cliente = historia_clinica.cod_cliente 
WHERE ((historia_clinica.fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (historia_clinica.nombre_empresa='$nombre_empresa') 
AND ((historia_clinica.motivo='$motivo') OR (historia_clinica.motivo='$motivo2') OR (historia_clinica.motivo='$motivo3')) AND (cod_estado_facturacion=1)) ORDER BY historia_clinica.fecha_ymd DESC";
$resultado_motivo_conteo = mysqli_query($conectar, $sql_motivo_conteo);
}
...
AND (cod_estado_facturacion=1)) ORDER BY historia_clinica.fecha_ymd DESC";
$resultado_motivo_conteo = mysqli_query($conectar, $sql_motivo_conteo);
}
...
WHERE ((historia_clinica.fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (historia_clinica.nombre_empresa='$nombre_empresa') 
AND ((historia_clinica.motivo='$motivo') OR (historia_clinica.motivo='$motivo2') OR (historia_clinica.motivo='$motivo3') OR (historia_clinica.motivo='$motivo4') 
  OR (historia_clinica.motivo='$motivo5')) AND (cod_estado_facturacion=1)) ORDER BY historia_clinica.fecha_ymd DESC";
$resultado_motivo_conteo = mysqli_query($conectar, $sql_motivo_conteo);
}
...
WHERE ((historia_clinica.fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (historia_clinica.nombre_empresa='$nombre_empresa') 
AND ((historia_clinica.motivo='$motivo') OR (historia_clinica.motivo='$motivo2') OR (historia_clinica.motivo='$motivo3') OR (historia_clinica.motivo='$motivo4') 
  OR (historia_clinica.motivo='$motivo5') OR (historia_clinica.motivo='$motivo6')) AND (cod_estado_facturacion=1)) ORDER BY historia_clinica.fecha_ymd DESC";
$resultado_motivo_conteo = mysqli_query($conectar, $sql_motivo_conteo);
}
...
WHERE ((historia_clinica.fecha_ymd BETWEEN '$fecha_ini' AND '$fecha_fin') AND (historia_clinica.nombre_empresa='$nombre_empresa') 
AND ((historia_clinica.motivo='$motivo') OR (historia_clinica.motivo='$motivo2') OR (historia_clinica.motivo='$motivo3') OR (historia_clinica.motivo='$motivo4') 
  OR (historia_clinica.motivo='$motivo5') OR (historia_clinica.motivo='$motivo6') OR (historia_clinica.motivo='$motivo7') OR (historia_clinica.motivo='$motivo8')) AND (cod_estado_facturacion=1)) ORDER BY historia_clinica.fecha_ymd DESC";
$resultado_motivo_conteo = mysqli_query($conectar, $sql_motivo_conteo);
}
