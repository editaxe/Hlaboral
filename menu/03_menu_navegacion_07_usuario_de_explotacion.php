...
<li class="dropdown"><a href="#">Pacientes</a></li>

<li class="dropdown"><a href="#">Historia Clinica</a></li>
<li class="dropdown"><a href="#">Historia Clinica Consolidada</a></li>

<li class="dropdown"><a href="#">Entidad</a></li>

<li class="dropdown active"><a href="#" class="dropdown-toggle">Admin <b class="caret"></b></a>
<ul class="dropdown-menu">
<li><a href="#">Info Empresa</a></li>
<li><a href="#">Usuarios</a></li>
<li><a href="#">Cie - 10</a></li>
